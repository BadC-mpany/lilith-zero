...
",
    ...
    tokio::io::AsyncWriteExt::write_all(&mut stdin, payload.as_bytes())
        .await
        .unwrap();
    ...
    assert!(
        !marker_file.exists(),
        "DAEMON ESCAPED! Marker file was recreated after supervisor kill."
    );
}
