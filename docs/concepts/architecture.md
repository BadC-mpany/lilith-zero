...
```mermaid
graph TD
    classDef trusted fill:transparent,stroke:#01579b,stroke-width:2px;
    classDef untrusted fill:transparent,stroke:#b71c1c,stroke-width:2px;
    classDef managed fill:transparent,stroke:#33691e,stroke-width:2px;
